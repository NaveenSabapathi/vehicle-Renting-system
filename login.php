	...
	<section class="">
		...
		?>
			...
			<section class="caption">
				...
				<h3 class="properties" style="text-align: center">Range Rovers - Hero - Bajaj - Suzuki - Mercedes Benz - Landcruisers</h3>
			</section>
	...
	<footer>
		<div class="wrapper footer">
			<ul>
				...
				<li class="about">
					<p>TITAN KUSTOMS is an organized company that rents cars and other vehicles to clients at lower costs. We we are here to serve every people to meet up their vehicle need through our service</p>
					<ul>
		...
		<div class="copyrights wrapper">
			Copyright &copy; <?php echo date("Y")?> All Rights Reserved | Designed by TK group.
		</div>
	</footer><!--  end footer  -->
