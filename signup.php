	...
	<section class="">
		...
		?>
			...
			<section class="caption">
				<h2 class="caption" style="text-align: center">Find You Dream vehocle For Hire</h2>
				<h3 class="properties" style="text-align: center">Suzuki - yamaha - Mercedes Benz - Landcruisers</h3>
			</section>
...
<li class="links">
		...
		<div class="copyrights wrapper">
			Copyright &copy; <?php echo date("Y")?> All Rights Reserved | Designed by Titankustoms.
		</div>
	</footer><!--  end footer  -->
